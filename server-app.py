...
from file_downloader import downloader, getData, updateData, updateDataNew, putData
import cv2
...
def test():
    ...
    response = make_response('<h1>Success at {} (server time)</h1>'.format(current_time))
